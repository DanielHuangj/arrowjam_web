...
## 收缩拨动机制 — kind 14/15/16（关联文档）

产品需求原文：

- [新增两种机制.md](新增两种机制.md) — 收缩障碍、拨动杆、控制器玩法
- [新增两种机制编辑器需求.md](新增两种机制编辑器需求.md) — 编辑器交互与校验

工程文档（客户端阶段代号 **P8**，与上文「P8 AI 生成」无关）：

- [arrow_jaw_收缩拨动机制开发需求文档.md](arrow_jaw_收缩拨动机制开发需求文档.md) — 玩法、数据契约、FR、附录 A 编辑器摘要
- [arrow_jaw_收缩拨动机制开发步骤拆解.md](arrow_jaw_收缩拨动机制开发步骤拆解.md) — P8.0–P8.6 客户端步骤；附录 E-P8 编辑器要点
