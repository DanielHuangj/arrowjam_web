...
## 11. 关联：P5 新机制（kind 2/5/7/13）

P0–P4 完成后，下一期为 **P5 新机制阶段**，新增翻转箭、定时炸弹、移动墙、冻结箭四种物件。规格与实施计划见：

- [arrow_jaw_新机制开发需求文档.md](arrow_jaw_新机制开发需求文档.md)
- [arrow_jaw_新机制开发步骤拆解.md](arrow_jaw_新机制开发步骤拆解.md)
- 玩法来源：[Arrow Jam 新增规则内容.md](Arrow%20Jam%20新增规则内容.md)
